<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysMenuItemTypeEdit.aspx.cs" Inherits="Treasure.Main.ProjectCollection.FirstProject.SysMenuItemTypeEdit" %>
        ...
        <div>
            <table>
                ...
                <tr>
                    <td>序号：</td>
                    <td>
                        <dx:ASPxTextBox ID="txtSORT_INDEX" runat="server" Width="170px">
                        </dx:ASPxTextBox>
                    </td>
                </tr>
            </table>
